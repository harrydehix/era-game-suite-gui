...
public abstract class Game<Q extends Question, D extends Difficulty, M extends Mode> implements Iterable<Q> {
    ...
    public Game(int questionCount, D difficulty, M mode, Class<Q> questionClass, long id) {
    ...
    public void generateStatistics() {
        ...
        this.statistics = new GameStatistics(correctAnswers, getQuestions().length, TimeUtils.seconds(timer.getMeasuredTime()), this::calculateScore, difficulty, mode, this);
    }

    protected abstract Double calculateScore(GameStatistics gameStatistics);
